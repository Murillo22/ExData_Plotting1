...
png(file="plot4.png",width=480,height=480)
 ...
 plot(input$D_T,input$Global_active_power,type="l",ylab="Global Active Power",xlab="")
 plot(input$D_T,input$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
lines(input$D_T,input$Sub_metering_3,type="l",col="slateblue2")
 legend("topright",lwd=2, bty="n",col=c("black","red","slateblue2"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
 plot(input$D_T,input$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime")
dev.off()